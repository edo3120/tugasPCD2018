...
public class SaltAndPepper {
	...
	BufferedImage image1 = ImageIO.read(new File("D:\\Kuliah\\7\\Pengolahan Citra Digital\\fruits.png"));
	...
	for(int i=0; i<height; i++){
			...
			try{
			      f = new File("D:\\Kuliah\\7\\Pengolahan Citra Digital\\saltpepper.png");
